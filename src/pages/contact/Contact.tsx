...
function Contact(): React.ReactElement {
  return (
    <Main id="contact">
      ...
      <section id="contact-left-panel">
        ...
        <article id="delivery">
          ...
          <ul>
            <li>
              <p>
                Please refer to the delivery map below. Deliveries are
                unavailable outside of these specified areas:
              </p>
            </li>
            <li>
              <p>
      ...
      <section id="contact-right-panel">
